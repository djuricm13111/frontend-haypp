...
function PrivacyCrumbsNav() {
  const { t } = useTranslation();
  return (
    <Crumbs aria-label={t("PRIVACY.BREADCRUMB_ARIA")}>
      <CrumbsList>
        <CrumbsItem>
...
function PrivacyPolicy() {
  ...
  const canonical = `https://www.snusco.at/${lang}/privacy`;
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={t("PRIVACY.PAGE_DESCRIPTION")} />
      ...
      <Shell>
        <LayoutWrap>
          <PrivacyCrumbsNav />
          <Title>{t("PRIVACY.HEADING")}</Title>
          <Subline>
            {t("PRIVACY.SUBLINE", { date: PRIVACY_LAST_UPDATED })}
          </Subline>
